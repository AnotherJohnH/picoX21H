...
public:
   ...
   const char* genREADME()
   {
      ...
      s += snprintf(s, end_s - s, "Program  : picoX21H (%s)\n", HW_DESCR);
...
private:
   ...
   const char* index_html =
      "<html>"
         "<head>"
            "<meta http-equiv=\"refresh\" content=\"0;URL='https://github.com/AnotherJohnH/picoX21H'\"/>"
         "</head>"
         "<body>"
            "Redirecting to <a href='https://github.com/AnotherJohnH/picoX21H'>github.com</a>"
         "</body>"
      "</html>";
};
